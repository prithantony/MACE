...
<section class="py-20">
    <div id="about-content" class="mx-auto grid max-w-7xl scroll-mt-28 gap-8 px-4 sm:px-6 lg:grid-cols-[1.15fr_0.85fr] lg:px-8">
        <article class="fade-up overflow-hidden rounded-[2rem] bg-white text-lg leading-8 text-slate-700 shadow-[0_16px_40px_rgba(15,54,25,0.10)] ring-1 ring-green-900/10">
        ...
        <aside class="grid content-start gap-5">
            ...
            <div class="fade-up overflow-hidden rounded-[2rem] bg-[#f7fbf6] shadow-[0_16px_40px_rgba(15,54,25,0.08)] ring-1 ring-green-900/10">
                <div class="h-4 bg-[#006b12]"></div>
                <div class="p-7">
            ...
            <div class="fade-up overflow-hidden rounded-[2rem] bg-white shadow-[0_16px_40px_rgba(15,54,25,0.08)] ring-1 ring-green-900/10">
                <div class="h-4 bg-[#006b12]"></div>
                <div class="p-7">
...
<section class="py-20">
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div class="overflow-hidden rounded-2xl bg-white text-lg leading-8 text-slate-700 shadow-[0_16px_40px_rgba(15,54,25,0.10)] ring-1 ring-green-900/10">
            <div class="h-4 bg-[#006b12]"></div>
            <div class="p-8">
                {!! nl2br(e($page->body)) !!}
            </div>
